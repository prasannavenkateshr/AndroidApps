...
public class Favorites extends ListActivity {
	...
	private static String url_all_products = "http://180.215.114.192/favorites.php";
		...
		protected void onPostExecute(String file_url) {
			...
			runOnUiThread(new Runnable() {
				public void run() {
					 ...
					 * */
					ListAdapter adapter = new SimpleAdapter( Favorites.this, productsList, R.layout.list_item, new String[] { TAG_PID,	TAG_NAME, TAG_AREA, TAG_COMPANY}, new int[] { R.id.pid, R.id.name, R.id.area, R.id.company});
