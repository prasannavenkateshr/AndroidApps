...
public class Locate extends ListActivity {
	...
	//private static String url_all_products = "http://59.92.51.182/nearby.php";
	...
	public void onCreate(Bundle savedInstanceState) {
     ...
     // Hashmap for ListView
		...
		//url_all_products = "http://180.215.114.56/nearby.php?location=" + lc.getText().toString();
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
       		...
       		// Loading products in Background Thread
        	    ...
        	    try {
        	        HttpClient httpclient = new DefaultHttpClient();
        	        HttpPost httppost = new HttpPost("http://59.92.51.182/nearby.php?location=");
        	        httppost.setEntity(new UrlEncodedFormEntity(nameValuePairs));
        	        HttpResponse response = httpclient.execute(httppost);
        	        HttpEntity entity = response.getEntity();
        	        InputStream is = entity.getContent();
	...
	class LoadAllProducts extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... args) {
			...
			//jParser.makeHttpRequest(url_all_products, null, null);
			JSONObject json = jParser.makeHttpRequest("http://180.215.114.192/product.txt", "GET", params);
		...
		protected void onPostExecute(String file_url) {
			...
			runOnUiThread(new Runnable() {
				public void run() {
					 ...
					 * */
					ListAdapter adapter = new SimpleAdapter( Locate.this, productsList, R.layout.list_item, new String[] { TAG_PID, TAG_COUPON,TAG_NAME, TAG_AREA, TAG_COMPANY}, new int[] { R.id.pid, R.id.coupon, R.id.name, R.id.area, R.id.company});
